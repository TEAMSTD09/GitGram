...
if ENV:
    ...
    GIT_REPO_URL = environ.get('GIT_REPO_URL', "https://github.com/TEAMSTD09/GitGram")
else:
...
print("If you need more help from Me, Join @teamstd09 in Telegram.")
...
def support(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*ɢᴇᴛᴛɪɴɢ sᴜᴘᴘᴏʀᴛ*\n\nꜰᴏʀ ɢᴇᴛᴛɪɴɢ ʜᴇʟᴘ ɪɴ ᴜsɪɴɢ ᴍᴇ, ᴊᴏɪɴ [Anonymous Support](https://t.me/teamstd09).",
...
def source(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*sᴏᴜʀᴄᴇ​*:\n[ɢɪᴛɢʀᴀᴍ ʀᴇᴘᴏ​](https://github.com/TEAMSTD09/GitGram).",
        disable_web_page_preview=True,
        parse_mode="markdown"
    )
